          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="/FinalMVCProject/resources/assets/images/banner-right-image.png" alt="team meeting">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center  wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
          <div class="left-image">
            <img src="/FinalMVCProject/resources/assets/images/services-left-image.png" alt="">
          </div>
        </div>
          ...
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
              ...
              <div class="showed-content">
                <img src="/FinalMVCProject/resources/assets/images/portfolio-image.png" alt="">
              </div>
            </div>
          </a>
        </div>
  ...
  <div id="blog" class="our-blog section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.25s">
          <div class="top-dec">
            <img src="/FinalMVCProject/resources/assets/images/blog-dec.png" alt="">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
          <div class="left-image">
            <a href="#"><img src="/FinalMVCProject/resources/assets/images/big-blog-thumb.jpg" alt="Workspace Desktop"></a>
            <div class="info">
            ...
            <ul>
              <li>
                ...
                <div class="right-image">
                  <a href="#"><img src="/FinalMVCProject/resources/assets/images/blog-thumb-01.jpg" alt=""></a>
                </div>
              </li>
              <li>
                <div class="left-content align-self-center">
